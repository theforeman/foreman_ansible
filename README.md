...
(To obtain a valid certificate for your proxy host follow the procedure as described [here](http://theforeman.org/manuals/latest/index.html#4.3.10SSL).)
...
In case of problems during fact and report importing check Foreman's log file under ```/var/log/foreman/production.log```.

If you find a bug, please file it in [Redmine](http://projects.theforeman.org/projects/foreman_ansible/issues/new).

See the [troubleshooting section](http://theforeman.org/manuals/latest/index.html#7.2GettingHelp)in the Foreman manual for more info.
